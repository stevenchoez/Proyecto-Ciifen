...
const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      { path: "", redirectTo: "pluviogramas", pathMatch: "full" },
      {
        path: "dashboard",
        loadChildren: () =>
      ...
      },
      {
        path: "solicitudes",
        loadChildren: () =>
          import("./views/pages/solicitudes/solicitudes.module").then(
      ...
      },
      {
        path: "reportes",
        loadChildren: () =>
          import("./views/pages/reportes/reportes.module").then(
            (m) => m.ReportesModule
          ),
      },
      {
        path: "inventario",
        loadChildren: () =>
          import("./views/pages/inventario/inventario.module").then(
      ...
      },
      {
        path: "pluviogramas",
        loadChildren: () =>
          import("./views/pages/pluviograma/pluviograma.module").then(
            (m) => m.PluviogramaModule
          ),
      },
