...
import { EventListComponent } from '../events-manager/event-list/event-list.component';
import { EventDetailComponent } from '../events-manager/event-detail/event-detail.component';
